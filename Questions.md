...
- [y] Adding more EC2 instances of the same size to handle an increase in traffic.
...
- [ ] Applying the principle of least privilege to all AWS resources. #least access ->security
- [y] Automatically provisioning new resources to meet demand.        
- [ ] All AWS services are considered Global Services, and this design helps customers serve their international users. #availiability
- [ ] Providing compensation to customers if issues occur. #what ?
- [y] Ability to recover quickly from failures.

**[⬆ Back to Top](#table-of-contents)**

### Which statement is true regarding the AWS Shared Responsibility Model?

- [y] Responsibilities vary depending on the services used.      # kinda
- [ ] Security of the IaaS services is the responsibility of AWS.
- [ ] Patching the guest OS is always the responsibility of AWS. #no 
- [ ] Security of the managed services is the responsibility of the customer. #no
...
- [y] All accounts can receive the hourly cost benefit of the Reserved Instances. #RI's can be transferred within org
...
- [y] Deploy the application across multiple Regions and Availability Zones.
...
- [y] Built-in computing capabilities that allow customers to process data locally.
...
- [y] Secure transfer of large amounts of data into and out of the AWS.
...
- [ ] Applying the Amazon Connect latency-based routing policy. #this is also an solution
...
- [y] Deploying new Amazon EC2 instances in a Region located in the US. #but this is a better option
...
- [ ] IAM roles.
- [ ] IAM users.
- [y] IAM user groups.  #because question said teams  so canvas like approach
- [ ] AWS Organizations.
...
- [ ] AWS OpsWorks.
- [y] AWS Database Migration Service.
...
- [y] Increasing speed and agility.
...
- [y] All of the physical security and most of the data/network security are taken care of for you.
...
- [y] Reduces inter-dependencies so that failures do not impact other components of the application.
...
- [y] The consolidated billing feature is just for organizational purpose.
- [ ] Each AWS account gets volume discounts. #does it? 
...
- [y] Create EBS snapshots.
- [y] Ensure that EBS data is encrypted at rest.
...
- [y] By automatically provisioning the required AWS resources based on changes in demand.
...
- [y] Setup a CloudWatch billing alarm that triggers an SNS notification when the threshold is exceeded.
- [ ] Configure the Amazon Simple Email Service to send billing alerts to their email address on a daily basis.
- [y] Configure the AWS Budgets Service to alert the company when the threshold is exceeded.
...
- [y] You should grant your users only the permissions they need when they need them and nothing more.
...
- [ ] Infrastructure as a Service (IaaS).
- [ ] Software as a Service (SaaS).
- [y] Networking as a Service (NaaS).
...
- [ ] S3 Intelligent-Tiering. #this also makes sense
- [ ] AWS Marketplace.
- [y] Amazon S3 Glacier Deep Archive. #but it says cost effective
- [ ] Amazon EBS.
...
- [ ] AWS OpsWorks. # not required
- [ ] AWS Storage Gateway. # not required
- [ ] Amazon EBS volume. # fast
- [y] Amazon ElastiCache. #faster
...
- [ ] Amazon VPC.
- [ ] Amazon DynamoDB. #kinda
- [y] Amazon Elastic MapReduce.
- [y] AWS IAM.
...
- [y] Technical Account Manager (TAM).
...
- [y] ELB. #ELB health check
- [y] Auto Scaling.
- [ ] Amazon Athen. # in detection ?
- [ ] ECR.
- [ ] Amazon EC2.
...
- [y] Configuring infrastructure devices.
...
- [y] Health checks for Auto Scaling instances.
- [y] Recommendations for Cost Optimization.
...
- [y] Amazon S3 can run any type of application or backend system.
- [ ] Amazon S3 stores any number of objects, but with object size limits.
- [y] Amazon S3 can be scaled manually to store and retrieve any amount of data from anywhere.
...
- [y] Setting password complexity rules.
- [y] Configuring network access rules.
...
- [y] AWS Quick Start reference deployments. #maybe
...
- [y] Amazon S3 Intelligent-Tiering.
...
- [y] You have to pay a start-up fee when launching a new instance for the first time.
...
- [y] AWS Trusted Advisor.
- [ ] Amazon Inspector. #does it, isnt inspector about EC2
- [ ] Amazon SNS.
- [ ] Amazon CloudWatch.
- [y] Concierge Support Team.
...
- [y] Automate wherever possible to make architectural (© ) experimentation easier.
...
- [y] Penetration testing can be performed by the customer on their own instances without prior authorization from AWS.
...
- [y] Protecting the confidentiality of data in transit in Amazon S3.
- [ ] Controlling physical access to AWS Regions.
- [ ] Ensuring that the underlying EC2 host is configured properly.
- [y] Patching applications installed on Amazon EC2.
...
- [y] In-memory caching for read-heavy applications.
...
- [y] Reduced Capital Expenditure (CapEx).
...
- [y] Automate wherever possible.
- [y] Remove single points of failure.
...
- [y] Creating hypervisors.
- [ ] Configuring Access Control Lists (ACLs).
- [y] Hardware maintenance.
...
- [ ] IAM.
- [ ] An internet gateway.
- [ ] EBS Snapshot. #kinda true as well
- [y] AMI.
...
- [y] Distributed infrastructure.
- [y] Virtualized compute resources.
- [ ] Dedicated hosting.
...
- [ ] Access permissions.
- [y] Hardware patching.
- [y] Securing global physical infrastructure.
...
- [y] The ability to monitor systems and improve supporting processes and procedures.
...
- [y] Edge locations are used by CloudFront to distribute traffic across multiple instances to reduce latency.
...
- [y] Use the right combination of storage classes based on different use cases.
...
- [y] Enabling Amazon EC2 Auto Scaling for all of your workloads.
...
- [y] Building the relational database schema.
- [ ] Performing backups.
- [y] Managing the database settings.
...
- [y] She has properly built a fault tolerant system.
...
- [y] Right-size before and after migration.
...
- [ ] Amazon Redshift.
- [ ] AWS Snowball.
- [y] Amazon Simple Storage Service.
- [ ] Amazon EBS.
- [y] Amazon DynamoDB.
...
- [y] Create a CDN using CloudFront, so that content is cached at Edge Locations close to and in Asia.
...
- [y] AWS Identity and Access Management. #AWS users and groups
- [ ] Amazon RDS.
...
- [y] Decouple the components of the application so that they run independently.
...
- [y] A compute engine for Amazon ECS.
...
- [y] Reserved instances - Partial Upfront.
- [ ] On-Demand instances.
- [ ] Spot Instances.
...
- [y] Deploy AWS resources to another AWS Region and implement an Active-Active disaster recovery strategy.

**[⬆ Back to Top](#table-of-contents)**

### Which statement is correct with regards to AWS service limits? (Choose TWO)

- [y] You can contact AWS support to increase the service limits. #for some
- [ ] Each IAM user has the same service limit.
- [ ] There are no service limits on AWS.
- [y] You can use the AWS Trusted Advisor to monitor your service limits.
- [ ] The Amazon Simple Email Service is responsible for sending email notifications when usage approaches a service limit. #kind off
...
- [y] AWS Application Load Balancer.
...
- [ ] AWS Batch.
- [ ] AWS IAM.
- [y] Network Access Control Lists (Network ACLs).
...
- [y] EC2 instances will be billed on one minute increments, with a minimum of one hour.
...
- [y] Instance type.
- [ ] The Availability Zone where the instance is provisioned. #kinda
- [ ] Load balancing.
- [ ] Number of buckets.
- [y] Number of private IPs.
...
- [y] By creating an EBS Snapshot of the old instance.
...
- [ ] IAM Principals.
- [y] AWS Service Control Policies (SCPs).
- [ ] IAM policies.
- [ ] AWS Fargate.
...
- [y] AWS allows you to provision resources in minutes.
...
- [y] Lower administrative burden.
- [ ] Complete control over the underlying host.
- [y] Resizable compute capacity.
...
- [y] Network Access Control Lists (NACLs).
- [ ] Key Pairs.
- [ ] Access Keys.
- [ ] IAM Policies.
- [y] Security Groups.
...
- [ ] AWS Management Console.
- [ ] Amazon CloudWatch.
- [y] AWS Personal Health Dashboard.
...
- [y] Reserved instances require at least a one-year pricing commitment.
- [ ] There is no additional charge for using dedicated instances.
- [y] Reserved instances provide a significant discount compared to on-demand instances.
...
- [y] Multiple Availability Zones allows you to build resilient and highly available architectures.
...
- [y] Increases the availability of your application.
...
- [y] AWS destroys the old devices in accordance with industry-standard practices.
...
- [ ] Access control.
- [y] Operating system maintenance.
- [ ] Data management.
...
- [y] By ensuring that only healthy targets receive traffic.
...
- [y] Allows customers to deliver new solutions faster.
- [y] Lowers operational complexity.
...
- [y] It allows for programmatic management of AWS resources.
...
- [y] Customers can use the AWS Budgets service to track the reserved instances usage and set up alert notifications when their utilization drops below the threshold that they define.
...
- [y] It simplifies organizing and governing commonly deployed IT services.
...
- [y] Patching the database software.
- [y] Operating system maintenance.
...
- [y] An AWS Region is a geographical location with a collection of Availability Zones.
...
- [y] Quickly identify resources that belong to a specific project.
...
- [y] Track AWS spending across multiple resources.
...
- [y] Controls that the customer and AWS collaborate together upon to secure the infrastructure.
...
- [y] Implement strong Identity and Access controls.
- [y] Use serverless architectures.
...
- [y] Installing and configuring third-party software.
...
- [y] Amazon EC2 is considered a Serverless Web Service. #not
- [ ] Amazon EC2 eliminates the need to invest in hardware upfront. #yes
- [ ] Amazon EC2 can launch as many or as few virtual servers as needed. #yes
- [ ] Amazon EC2 offers scalable computing. #yes
...
- [y] Using AWS CloudFormation to manage infrastructure as code.
...
- [y] Using AWS, they can reduce time-to-market by focusing on business activities rather than on building and managing data centers.
- [ ] AWS removes the need to invest in operational expenditure.
- [y] Using AWS allows companies to replace large capital expenditure with low variable costs.

**[⬆ Back to Top](#table-of-contents)**

### What are the benefits of using DynamoDB? (Choose TWO)

- [ ] Automatically scales to meet required throughput capacity. #maybe
- [ ] Provides resizable instances to match the current demand. 
- [ ] Supports both relational and non-relational data models.
- [y] Offers extremely low (single-digit millisecond) latency.
- [y] Supports the most popular NoSQL database engines such as CouchDB and MongoDB.
...
- [y] Deleting unused AutoScaling launch configuration.
...
- [ ] AWS Pricing Calculator.
- [ ] AWS Budgets.
- [ ] AWS Consolidated Billing. #maybe
...
- [ ] Reserving capacity.
- [y] Data center operations.
- [ ] Auditing and regulatory compliance.
- [y] Infrastructure security.
...
- [ ] Amazon Simple Storage Service (Amazon S3).
- [y] Amazon Simple Notification Service (Amazon SNS).
...
- [ ] AWS Security Team. #secOps only
- [ ] AWS Professional Services. # not AWS
- [y] AWS Trusted Advisor.
- [ ] AWS Concierge Support Team. # billing only
...
- [y] 2 hours, 5 minutes and 9 seconds for the Linux instance and 4 hours, 23 minutes and 7 seconds for the CentOS instance.
...
- [ ] AWS Global Accelerator.
- [y] AWS Application Load Balancer (ALB).
- [ ] Amazon CloudFront.
- [ ] Transit VPC.
...
- [ ] Use AWS CodeDeploy to build and automate your AWS environment. #maybe
- [y] Use code to provision and operate your AWS infrastructure.
...
- [y] Require Multi-Factor Authentication (MFA) for all IAM User access.
...
- [y] Geographic proximity to the company's location.
...
- [y] Auto Scaling Groups scales EC2 instances in multiple Availability Zones to increase application availability and fault tolerance.
...
- [y] AWS continues to lower the cost of cloud computing for its customers.
...
- [y] The amount of time the instances will be running. #very imp
- [ ] Number of security groups. #no imp
- [ ] Allocated Elastic IP Addresses. #mid imp
- [ ] Number of Hosted Zones. # no imp
- [y] Number of instances. #very imp
...
- [ ] AWS Data Pipeline.
- [y] AWS Storage Gateway. # this or Outposts
- [ ] Amazon Aurora.
- [ ] Amazon EFS.
...
- [ ] AWS Storage Gateway. #but it would store in s3 only 
...
- [y] There is a non-explicit deny to all new users.
...
- [y] Amazon Cloud Directory allows users to access AWS with their existing Active Directory credentials.
...
- [y] Deploy the application to at least two Availability Zones.
- [ ] Use Elastic Load Balancing (ELB) across multiple AWS Regions. #can ELB work across AZs ?
...
- [y] Labor and IT costs.
- [y] Cooling and power consumption.
...
- [y] Create an IAM role and attach a policy with Amazon DynamoDB access permissions.
...
- [ ] Generate new IAM access keys every time you delegate permissions. #good practice for users not applications, similar to config-ssh
- [ ] Store the required AWS credentials directly within the application code.
- [y] Use temporary security credentials (IAM roles) instead of long-term access keys. #maybe
...
- [y] Use existing third-party software licenses on AWS. #kinda
- [ ] Migrate production workloads to AWS edge locations instead of AWS Regions.
- [ ] Use AWS Outposts to run all workloads in a cost-optimized environment. #kinda
...
- [y] Running EC2 instances in parallel.
...
- [ ] Stop all running services and open an investigation. #maybe they are testing stages started by other devs , so no
- [ ] Give your root account password to AWS Support so that they can assistin troubleshooting and securing the account. #NEVER give out root creds
- [ ] Check the AWS CloudTrail logs and delete all IAM users that have access to your resources.  #maybe they are testing stages started by other devs , so no
- [y] Open an investigation and delete any potentially compromised IAM users. #yes only potential false users
- [y] Change your AWS root account password and the passwords of any IAM users. #yes
...
- [ ] Automate the process of provisioning new compute resources. #kinda
- [y] Make synchronous replication of your data possible.

**[⬆ Back to Top](#table-of-contents)**

### Which of the following are true regarding the languages that are supported on AWS Lambda? (Choose TWO)

- [ ] Lambda only supports Python and Node.js, but third party plugins are available to convert code in other languages to these formats. #0.5
- [y] Lambda natively supports a number of programming languages such as Node.js, Python, and Java.
...
- [y] Lambda can support any programming language using an API. #0.5
...
- [y] Facilitates tracking of user requests to identify application issues.
- [y] Helps improve application performance.
...
- [y] An AWS Availability Zone is an isolated location within an AWS Region, however edge locations are located in multiple cities worldwide.

**[⬆ Back to Top](#table-of-contents)**

### Which features are included in the AWS Business Support Plan? (Choose TWO)

- [y] 24x7 access to customer service.
...
- [y] 24x7 access to the TAM feature.
...
- [y] Eliminates the need to guess on infrastructure capacity needs.
- [y] Enables customers to trade their capital expenses for operational expenses.
...
- [ ] AWS File Transfer Acceleration. #file transfer gateway
- [y] AWS Server Migration Service.
...
- [y] It helps AWS customers deploy their applications without worrying about the underlying infrastructure. #IaC?
- [ ] It applies advanced IAM security features automatically. #no
- [y] It automates the provisioning and updating of your infrastructure in a safe and controlled manner. #kinda
- [ ] It allows you to model your entire infrastructure in just a text file. #txt file or tf files
- [ ] It compiles and builds application code in a timely manner. # no
...
- [ ] In another Region. #maybe
- [ ] In another VPC.
- [y] In another Availability Zone.

**[⬆ Back to Top](#table-of-contents)**

### Which statement is true in relation to the security of Amazon EC2?

- [ ] You should use instance store volumes to store login data. #maybe
- [y] You should regularly patch the operating system and applications on your EC2 instances. #yes
- [ ] You should deploy critical components of your application in the Availability Zone that you trust. #All AZs have same base security config
- [ ] You can track all API calls using Amazon Athena. # athena is sql search of s3

**[⬆ Back to Top](#table-of-contents)**

### What does AWS Cost Explorer provide to help manage your AWS spend?

- [ ] Cost comparisons between AWS Cloud environments and on-premises environments. # TCO
- [ ] Accurate estimates of AWS service costs based on your expected usage. Billing
- [ ] Consolidated billing. # Billing
- [y] Highly accurate cost forecasts for up to 12 months ahead.
...
- [y] Apply MFA for the root account and use it for all of your work.
...
- [y] The size of volumes provisioned per month.
- [ ] The compute capacity you consume.
- [y] The amount of data you have stored in snapshots.
...
- [y] Apply the Principle of Least Privilege.
...
- [y] A user who chooses to buy Reserved, Standard, All upfront instances.

**[⬆ Back to Top](#table-of-contents)**

### Which of the following is an available option when purchasing Amazon EC2 instances?

- [ ] The ability to bid to get the lowest possible prices. #spot
- [ ] The ability to register EC2 instances to get volume discounts on every hour the instances are running.
- [ ] The ability to buy Dedicated Instances for up to 90% discount. #yes
- [ ] The ability to pay upfront to get lower hourly costs. #lower total cost hence lower hourly cost
...
- [ ] It means as more time passes using AWS, you pay more for its services. #no
- [y] It means that AWS will continuously lower costs as it grows.
- [ ] It means that you have the ability to pay as you go. #no
...
- [y] AWS Customers have complete control over their Amazon VPC virtual networking environment. #user sandbox
- [ ] AWS is responsible for all the management and configuration details of Amazon VPC.
- [ ] Amazon VPC helps customers to review their AWS architecture and adopt best practices. #kinda
...
- [ ] AWS Config.
- [ ] Amazon Redshift.
- [y] Amazon MQ. #whats this
- [y] AWS Trusted Advisor.
- [ ] Amazon Cognito. #maybe compliance but vuls ?
...
- [y] Testing your network to find security vulnerabilities that an attacker could exploit.
...
- [y] Enables you to analyze and process extremely large amounts of data in a timely manner.
- [y] Enables you to easily run and scale Apache Spark, Hadoop,and other Big Data frameworks.
...
- [y] At a minimum, upgrade to Business support plan.
...
- [y] With AWS, you replace large capital expenses with low variable payments.
...
- [y] Database setup.
- [ ] Network traffic protection. #via SGs
- [y] Management of the operating system.
- [ ] Access management. #via IAM
- [ ] Management of firewall rules. #via subnets

**[⬆ Back to Top](#table-of-contents)**

### Which of the following strategies help analyze costs in AWS?

- [y] Using tags to group resources.
...
- [y] It allows integration of on-premises IT environments with Cloud Storage.
...
- [y] Amazon S3 Standard-Infrequent Access.
- [ ] Amazon S3 Glacier.
- [ ] Instance Store.
...
- [y] With the Server-based Architectures, compute resources continue to run all the time but with serverless architecture, compute resources are only used when code is being executed.
...
- [ ] Point-to-point connectivity between an on-premises data center and AWS. #strong maybe
- [ ] Detects configuration changes in the AWS environment.
- [y] DNS configuration and management.
- [y] Manages global application traffic through a variety of routing types.
...
- [ ] Amazon Athena.
- [ ] AWS Cloud9.
- [y] Amazon ElastiCache for Redis.
...
- [y] Enable S3 Encryption.
- [y] Encrypt the data prior to uploading it.
...
- [y] The storage class used for the objects stored.
- [ ] Creating and deleting S3 buckets.
- [y] The total size in gigabytes of all objects stored.
...
- [y] Increases application availability by caching at the edge.
- [ ] Enables faster disaster recovery.
- [ ] Stores archived data at very low costs.
- [y] Delivers content to end users with low latency.
...
- [y] Using the AWS Cost & Usage Report.
...
- [y] AWS Resource Groups.
- [ ] AWS Placement Groups.
- [ ] AWS Management Console.
- [ ] AWS Tag Editor. # maybe +CW
...
- [ ] Tagging Enforcement.
- [y] Architecture Optimization.
- [ ] Budgeting Processes. #isnt this initial budgets
- [ ] Resource Controls.
...
- [y] AWS allows customers to launch and terminate EC2 instances based on demand.
...
- [y] Run WordPress on an Amazon Lightsail instance.
...
- [y] AWS KMS.
- [ ] AWS Certificate Manager. #get certs from outside
- [ ] AWS CodeDeploy.
- [ ] AWS CodeCommit.
- [y] CloudHSM.
...
- [ ] ELB.
- [ ] Amazon Route53.
- [ ] Amazon Elastic Container Service. #kinda
...
- [y] Loose coupling over tight coupling.
- [ ] Servers instead of managed services.
- [y] Disposable resources instead of fixed servers.
- [ ] Multi-AZ deployments instead of multi-region deployments. #maybe
...
- [y] Deploy the application in muitiple Availability Zones in multiple AWS regions.
...
- [y] Securing regions and edge locations.
...
- [ ] AWS Lambda runs code without provisioning or managing servers. #yes
- [ ] AWS Lambda provides resizable compute capacity in the cloud.
- [ ] There is no charge when your AWS Lambda code is not running. #yes
- [y] AWS Lambda can be called directly from any mobile app.
...
- [y] AWS has many common assurance certifications such as ISO 9001 and HIPAA.
...
- [ ] Control access to AWS services. #kind off
- [ ] Help organizations design and maintain an accelerated path to successful cloud adoption. #how?
- [y] Manage your organization's payment methods. #works
- [ ] Help organization achieve their desired business outcomes with AWS.
- [y] Consolidate billing across multiple AWS accounts. #works
...
- [y] Data center security controls.
- [y] Environmental controls.
...
- [y] Store media assets in the region closest to your end users.
...
- [y] Store media assets in S3 and use CloudFront to distribute these assets.
...
- [y] Use IAM roles to grant temporary access instead of long-term credentials.
- [ ] Scale horizontally to protect from failures.
- [y] Enable real-time traceability.
- [ ] Never store sensitive data in the cloud. #kms? crm?
...
- [y] Apply cost allocation tags to segment AWS costs by different e projects and departments.
...
- [y] Controls what IP address ranges can connect to your database instance.
...
- [y] EC2 launch type. #only server type here
- [ ] Fargate launch type.
...
- [y] Add the accounts to an AWS Organization and use Consolidated Billing.
...
- [y] Security Groups and Network ACLs.

**[⬆ Back to Top](#table-of-contents)**

### What does the AWS 'Business' support plan provide? (Choose TWO)

- [y] Access to the full set of Trusted Advisor checks. 
...
- [y] AWS customers are responsible for patching any database software running on Amazon EC2.
...
- [y] Improves Fault-Tolerance.
- [ ] Provides your business with a seamless remote accessibility.
- [y] Prevents unauthorized users from getting into your network.
...
- [y] With the AWS pay-as-you-go pricing model, you don't have to pay any upfront fee.
- [ ] You have no responsibility for third-party software license costs.
- [y] You only pay for the individual services that you need with no long-term contracts.
...
- [y] Use CloudWatch Alarms to monitor the CPUand alert when the CPU usage is >= 60%.
...
- [ ] Storage consumed.
- [y] Number of requests to your functions.
- [ ] Number of volumes.
- [ ] Placement groups.
- [y] Compute time consumed.

**[⬆ Back to Top](#table-of-contents)**

### What are the main differences between an IAM user and an IAM role in AWS? (Choose TWO)

- [y] An IAM user is uniquely associated with only one person, however a role is intended to be assumable by anyone who needs it.
...
- [y] An IAM user has temporary credentials associated withit, however a role has permanent credentials associated with it.
...
- [ ] Using reservations.
- [y] Deleting unnecessary snapshots.
- [y] Changing the type of the volume.
...
- [y] Continuously monitors AWS infrastructure and helps detect threats such as attacker reconnaissance or account compromise.
...
- [y] Amazon Glacier does not provide immediate retrieval of data.
...
- [y] Deploy your application across multiple Availability Zones.
...
- [y] It allows individual application compenents or services to be modified without affecting other components.
...
- [ ] Amazon Elastic Block Store. # one node per EBS
- [ ] AWS Storage Gateway. #for data from on prem 
- [y] Amazon Elastic File System. #windows only
- [ ] S3. #maybe
...
- [y] Protects customers by performing periodic security checks on listed products.
- [ ] Per-second billing.
...
- [y] Provides software solutions that run on AWS or any other Cloud vendor.

**[⬆ Back to Top](#table-of-contents)**

### What is the benefit of Amazon EBS volumes being automatically replicated within the same availability zone?

- [ ] Elasticity. # maybe we can spin up more machines on the same state
- [y] Durability. # maybe for data loss
- [ ] Traceability.  # how ?
- [ ] Accessibility. # how ?
...
- [y] Rotate all access keys.
- [y] Change the email address and password of the root user account and enable MFA.

**[⬆ Back to Top](#table-of-contents)**

### What is the Amazon ElastiCache service used for? (Choose TWO)

- [y] Provide an in-memory data storage service.
- [ ] Reduce delivery costs using Edge Locations.
- [y] Improve web application performance.
...
- [y] Use Amazon EC2 Auto Scaling.
- [ ] Deploy your resources in another region.
- [y] Use Elastic Load Balancing.
...
- [y] They remove the need to buy 'safety net' capacity to handle periodic traffic spikes.
- [ ] They only require 1-2 days for setup and configuration.
- [y] You can increase or decrease your compute capacity depending on the demands of your application.
...
- [y] It is a distinct location within a region that is insulated from « failures in other Availability Zones.
...
- [y] Ensure that AWS services are configured properly to meetall PCI DSS standards.
- [y] Restrict any access to cardholder data and create a policy that addresses information security for all personnel.
...
- [ ] 100 PetaBytes.
- [y] Virtually unlimited storage. #maybe
- [ ] 5TeraBytes.
- [ ] 10 Exabytes.
...
- [ ] Notify AWS support, and then conduct testing immediately. #maybe
- [y] Request and wait for approval from AWS support, and then conduct testing. #maybe

**[⬆ Back to Top](#table-of-contents)**

### Which AWS Cost Management tool allows you to view the most granular data about your AWS bill?

- [ ] AWS Cost Explorer. #see isolated price of a service
- [ ] AWS Budgets. #graphs
- [y] AWS Cost and Usage report. #csv
- [ ] AWS Billing dashboard. #more graphs + enterprise stuff
...
- [y] Ensure that the application is designed to accommodate failure of any single component.
...
- [ ] Amazon CloudFront.
- [ ] AWS CodeCommit.
- [y] AWS Quick Start reference deployments.

**[⬆ Back to Top](#table-of-contents)**

### What is one of the advantages of the Amazon Relational Database Service (Amazon RDS)?

- [y] It simplifies relational database administration tasks.
- [ ] It provides 99.99999999999% reliability and durability. #how many 9's
...
- [y] Launch the instances across multiple Availability Zones in a single AWS Region.
...
- [y] Updating Amazon EC2 host firmware.
...
- [y] Accessing forums, blogs, and whitepapers.
...
- [y] Amazon Simple Storage Service (Amazon S3).
...
- [y] Enable automate patching for the instances using the Amazon RDS console.
